...
//  * @returns number[][]
//  */
// const findNumbers = (grid: Grid): Grid => {
...
// 			const possibleValuesAfterSearch = getPossibleValuesForCell(cell.clone(), grid, allFreeCells);
...
//  */
// const findEmptyCells = (grid: Grid): Cell[] => {
// 	let freeCells: Cell[] = [];

// 	for (let i = 0; i <= 8; i++) {
// 		for (let j = 0; j <= 8; j++) {
// 			if (grid.getCell(i, j).getValue() === 0) {
// 				const cell = new Cell(i, j, [1,2,3,4,5,6,7,8,9], null);
// 				freeCells.push(cell);
// 			}
// 		}
// 	}
...
//  */
// const getPossibleValuesForCell = (cell: Cell, grid: Grid, allFreeCells: Cell[]): number[] => {
