...
const getRandomEasyGrid = (): string[][] => {
...
const getRandomMediumGrid = (): string[][] => {
...
const getRandomHardGrid = (): string[][] => {
...
export { getRandomEasyGrid, getRandomMediumGrid, getRandomHardGrid };